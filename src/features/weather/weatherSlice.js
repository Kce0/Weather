...
export const fetchFiveDaySearchResults = createAsyncThunk(
  "weather/fetchFiveDaySearchResults",
  async ({ query }) => {
...
// 오늘날씨
export const fetchTodayWeathers = createAsyncThunk(
  "weather/fetchTodayWeathers",
  async ({ category }) => {
    if (category === "today") {
...
// 5일간
export const fetch5dayWeathers = createAsyncThunk(
  "weather/fetch5dayWeathers",
  async ({ category }) => {
    if (category === "fiveday") {
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchSearchResults.fulfilled, (state, action) => {
        ...
        console.log("fetchSearchResults updated:", state.searchResults);
      })
      ...
      .addCase(fetchFiveDaySearchResults.fulfilled, (state, action) => {
        ...
        console.log(
          "fetchFiveDaySearchResults updated:",
          state.fivedaysearchResults
        );
      })
